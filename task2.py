...
csv_header = ['id', 'PASSENGER_WEIGHT_AVERAGE_KG', 'LOAD_FACTOR_EXPECTED_AVG', 'BENCHMARK_AVAIL_COMPETING_SYSTEMS', 'DWELL_TIME_SECONDS', 'autonomous_system', 'battery_pack', 'battery_charger', 'chasis', 'motor_and_inverter', 'total_vehicle_cost_1k_usd', 'total_vehicle_weight_kg', 'battery_charge_time_hours', 'power_consumption_Wh_per_km', 'range_km', 'average_speed_km_per_hour', 'uptime_hours', 'downtime_hours', 'availability']
